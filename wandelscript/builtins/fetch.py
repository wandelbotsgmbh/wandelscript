...
async def fetch(url: str, options: dts.Record | None = None) -> dts.Record:
    ...
    try:
        ...
        return dts.Record(data={"data": parsed_data, "status_code": response.status_code})

    except httpx.HTTPStatusError as exc:
        status_code = exc.response.status_code if exc.response else 500
        return dts.Record(data={"error": str(exc), "status_code": status_code})
